    ...
    <div className="diagonal-lines-bg min-h-screen">
      ...
      <section className="pt-32 pb-16 px-6 md:px-12 lg:px-16">
        <div className="max-w-7xl mx-auto flex items-center justify-center flex-col text-center">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-8 flex items-center justify-center tracking-tight text-center" data-aos="fade-up" data-aos-duration="3000">
            <span className="gradient-header">
              LET'S CONNECT
            </span>
          </h1>
          <p className="contact-paragraph text-white leading-loose text-lg normal-benzin w-1/2 text-center text-pretty" data-aos="fade-up" data-aos-duration="3000">
