...
console.log('📱 Open Graph Description:', ogDesc ? ogDesc.content : 'Not found');
...
structuredData.forEach((script, index) => {
  try {
    ...
    console.log(`📊 Schema ${index + 1}:`, data['@type'], data.name || data.url);
  } catch (e) {
...
console.log('📱 Test mobile-friendly: https://search.google.com/test/mobile-friendly');